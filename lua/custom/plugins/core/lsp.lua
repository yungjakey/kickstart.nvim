return {{'b0o/schemastore.nvim'}, {
    ...
    config = function()
        ...
        local servers = {
            ...
            taplo = {
                ...
                settings = {
                    evenBetterToml = {
                        schema = {
                            -- Disable built-in schema store to use custom ones
                            repositoryEnabled = false,
                            -- Custom schema associations
                            associations = {
                                ['https://json.schemastore.org/pyproject.json'] = 'pyproject.toml',
                                ['https://json.schemastore.org/poetry-lock.json'] = 'poetry.lock',
                                ['https://json.schemastore.org/pipfile.json'] = 'Pipfile',
                                ['https://raw.githubusercontent.com/astral-sh/ruff/main/ruff.schema.json'] = '{ruff,.ruff}.toml',
                                ['https://json.schemastore.org/taplo.json'] = '.taplo.toml',
                        ...
                        formatter = {
                            enabled = false -- Let your formatter handle this
                        }
                    }
                }
            },
        ...
        'goimports', 'shfmt', 'stylua', 'prettierd', 'fixjson', 'yamlfix', 'sqlfmt', 'djlint', -- Linters
        'golangci-lint', 'shellcheck', 'luacheck', 'jsonlint', 'yamllint', 'taplo', 'markdownlint', 'tflint',
        'hadolint', 'actionlint', 'sqlfluff', -- lsp
