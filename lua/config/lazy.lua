...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sr', builtin.oldfiles, { desc = '[S]earch [R] Files' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      textobjects = { -- Your textobjects config from before
        select = {
          enable = true,
          keymaps = {
            ['aa'] = '@parameter.outer',
    ...
    -- Make sure textobjects loads after nvim-treesitter
    dependencies = {
      'nvim-treesitter/nvim-treesitter-textobjects',
    },
    config = function(_, opts)
      -- This ensures nvim-treesitter itself is set up
      require('nvim-treesitter.configs').setup(opts)

      -- THIS IS WHERE YOU ADD THE REPEATABLE MOVE KEYMAPS:
      ...
      -- Optionally, you can also make built-in f, F, t, T repeatable:
      -- vim.keymap.set({'n', 'x', 'o'}, 'f', ts_repeat_move.builtin_f_expr, { expr = true, noremap = true, silent = true })
      -- vim.keymap.set({'n', 'x', 'o'}, 'F', ts_repeat_move.builtin_F_expr, { expr = true, noremap = true, silent = true })
      -- vim.keymap.set({'n', 'x', 'o'}, 't', ts_repeat_move.builtin_t_expr, { expr = true, noremap = true, silent = true })
      -- vim.keymap.set({'n', 'x', 'o'}, 'T', ts_repeat_move.builtin_T_expr, { expr = true, noremap = true, silent = true })
    end,
